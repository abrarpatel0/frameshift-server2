...
export class UserModel {
  ...
  static async findById(id) {
    const result = await query(
      'SELECT id, email, full_name, role, github_id, github_username, avatar_url, email_verified, auth_provider, created_at, updated_at, last_login FROM users WHERE id = $1',
      [id]
    );
